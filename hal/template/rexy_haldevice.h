...
// Key Value
//
#define VK_PAD_0	'0'			/* '0' key, ASCII '0'                      */
#define VK_PAD_1	'1'			/* '1' key, ASCII '1'                      */
#define VK_PAD_2	'2'			/* '2' key, ASCII '2'                      */
#define VK_PAD_3	'3'			/* '3' key, ASCII '3'                      */
#define VK_PAD_4	'4'			/* '4' key, ASCII '4'                      */
#define VK_PAD_5	'5'			/* '5' key, ASCII '5'                      */
#define VK_PAD_6	'6'			/* '6' key, ASCII '6'                      */
#define VK_PAD_7	'7'			/* '7' key, ASCII '7'                      */
#define VK_PAD_8	'8'			/* '8' key, ASCII '8'                      */
#define VK_PAD_9	'9'			/* '9' key, ASCII '9'                      */
...
#define VK_USER_LEFT		1			/* left key                                */
#define VK_USER_RIGHT		2			/* right key                               */
#define VK_USER_UP			3			/* up key                                  */
#define VK_USER_DOWN		4			/* down key                                */
